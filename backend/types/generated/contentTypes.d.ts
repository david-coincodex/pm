...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Article authors and editors';
    displayName: 'Author';
    mainField: 'name';
    pluralName: 'authors';
    singularName: 'author';
...
export interface ApiBundleBundle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A curated bundle of sites';
    displayName: 'Bundle';
    mainField: 'name';
    pluralName: 'bundles';
    singularName: 'bundle';
...
export interface ApiFeaturedFeatured extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Featured deals shown in the homepage carousel';
...
export interface ApiOfferOffer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A concrete offer for a deal, with affiliate link and optional schedule';
    displayName: 'Offer';
    mainField: 'offerType';
    pluralName: 'offers';
    singularName: 'offer';
  ...
  attributes: {
    ...
    allowsDownloads: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    full_price: Schema.Attribute.Decimal;
    isActive: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::offer.offer'> &
      Schema.Attribute.Private;
    offerKind: Schema.Attribute.Enumeration<['subscription', 'credits']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'subscription'>;
    offerType: Schema.Attribute.Enumeration<
      ['trial', 'monthly', 'quarterly', 'yearly', 'lifetime', 'credits']
    >;
...
export interface ApiPlatformPlatform extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'The company or platform operating one or more adult sites';
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    paymentMethods: Schema.Attribute.Component<'payment.method', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSaleSale extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Timed sale landing pages (e.g. Black Friday, Memorial Day)';
    displayName: 'Sale';
    mainField: 'title';
    pluralName: 'sales';
    singularName: 'sale';
...
export interface ApiSiteSite extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Unified content type for all site categories';
    displayName: 'Site';
    mainField: 'name';
    pluralName: 'sites';
    singularName: 'site';
  ...
  attributes: {
    ...
    typeDetails: Schema.Attribute.DynamicZone<
      [
        ...
        'site-details.cam-site-details',
        'site-details.dating-site-details',
        'site-details.tube-site-details',
      ]
    > &
